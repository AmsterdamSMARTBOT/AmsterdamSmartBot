...
#the method returns the map showing the parking's position
...
#the method creates the keyboard's buttons for choose parking
...
#the method creates the keyboard's buttons for choose electric charge point
...
#this method creates the row to show in the information table (for parkings)
...
#this method creates the row to show in the information table (for electric charge points)
...
#this method renders the table with all the rows created
...
#this method sends mail to the admins from homepage's contact form
#the current configuration is set for gmail's protocol (SMTP)
