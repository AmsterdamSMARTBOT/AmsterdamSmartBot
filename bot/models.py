...
#Class model to describe the preferences that the user can save       
...
#Class model that describe the Cronology of the actions took by the user      
...
#Class model that describe the shapes of the different parking zones        
...
#class model TimeSlot that describe the different pricing and timing for each parking zone   
