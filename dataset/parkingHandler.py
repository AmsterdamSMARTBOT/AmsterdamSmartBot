...
#calculate the distance between user's position and parking positions
...
#the method replies with the closest parking 
...
#the method send a table preview that contains the 3 closest parkings with informations about distance and free slots.        
...
#the method send the message with detailed informations about selected parking
...
#the method checks if there are informations about costs for the selected parking
