...
#the method gets all the parking zones included inside the defined radius starting from the sent position
...
#the method gets a random color to assign for a specific parking
def getRandomColor():
    r = lambda: random.randint(0, 255)
    color = '#%02X%02X%02X' % (r(), r(), r())
    return color

#the method creates the message to send to the user including all the informations regarding cost and timing 
...
#the method draws on the map all the parkings inside the radius and chooses the color to assign to each parking   
#the method also sends final message to the user   
