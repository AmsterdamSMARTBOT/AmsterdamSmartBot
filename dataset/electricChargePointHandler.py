...
#the method give to the user the choice to send his current GPS location or choose a different position 
...
#calculate the distance between user's position and charge points position
...
#the method anwers with the closest charge points
...
#the method send a table preview that contains the 3 closest charge points with informations about distance and free slots.
...
#the method send the message with detailed informations about selected charge point
...
#the method checks if there are informations, for the selected charge point, regarding the cost of the parking 
